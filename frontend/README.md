...
Screenshots and product framing: [package README](../README.md). Connect OpenClaw/Hermes: [CONNECT-AGENT.md](../CONNECT-AGENT.md). For professional agent ops, [Nexus Agents](https://assetsnexus.org). BIM/IFC, wiring, and VR/AR are out of scope here (AssetsNexus.org).
